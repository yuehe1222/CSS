...
class MinHeap:
    ...
    #     while l < r:
    #         p = (l + r - 1) // 2
    #         if self.heap[p][1] > self.heap[idx][1]:
    #             r = p
    #         elif self.heap[p][1] < self.heap[idx][1]:
    #             l = p
    #         else:
    #             break
    #     if l+1 == len(self.heap):
    #         return
    #     self.heap[l+1], self.heap[idx] = self.heap[idx], self.heap[l+1]
    #     self.idx_of_element[self.heap[l+1][0]], self.idx_of_element[self.heap[idx][0]] = (
    #         self.idx_of_element[self.heap[idx][0]],
    #         self.idx_of_element[self.heap[l+1][0]],
    #     )
    #     self.sift_up(idx)
